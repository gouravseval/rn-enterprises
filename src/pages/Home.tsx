...
import DemoError from "@/components/common/DemoError";
import DemoSuspense from "@/components/common/DemoSuspense";
...
const Home = () => {
  ...
  useEffect(() => {
    toast.error("This is the error message");
            ...
            <Card>
              ...
              <CardContent className="grid gap-4">
                ...
                <div className="grid gap-2">
                  <Label htmlFor="email">Quick Email</Label>
